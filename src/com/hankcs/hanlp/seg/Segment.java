...
//        System.out.println(wordNetAll);
    ...
    public List<Term> seg(String text)
    {
        ...
        Config.sentenceListNum=sentenceList.size();//把  斷句完的句子總數量 丟回給doc
            ...
            final int per = sentenceArray.length / config.threadNumber;//運算的句子輛/線程數 =每一個threading所要處理的句子數量
...
//        }
     ...
     * @return 单词列表
     */
    protected abstract List<Term> segSentence(char[] sentence); //protected 之 abstract型態之 function，在不同的packet裡面之類別，可以透過子繼承父類別方式去實作或純取。
